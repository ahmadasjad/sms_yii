...
<div class="row">
    ...
    <div class="col-md-9 col-sm-9">
        <div class="box box-info ">
            <div class="box-header"><h3 class="box-title"><?php echo Yii::t('students', 'Manage Student Categories'); ?></h3></div>
            <div class="box-body nav-tabs-custom">
                <div class="cont_right formWrapper">
                    <div class="edit_bttns" style="right:15px; top:12px;">
                        ...
                        ?>
                        <?php echo CHtml::link('<span>' . Yii::t('students', 'Create New Category') . '</span>', array('#'), array('id' => 'add_student-categories', 'class' => 'btn btn-primary')) ?>
                        <div class="clear"></div>
                    </div>
                    <div id="success_flash" align="center" style=" color:#F00; display:none;">
                        <h4>Selected category Deleted Successfully !</h4>
                    </div>
                </div>
                <?php $datas = StudentCategories::model()->findAll($criteria); ?>
                <div id="student-categories-grid" style="margin-top:15px;">
                                ...
                                foreach ($datas as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" class="ns">
                                            <div style="position:relative" id="d<?php echo $data->id ?>"><span class="s_no">
                                                <?php echo count($count) ?>
                                                    <a href="#" class="s_no_but" id="<?php echo $data->id ?>"></a>
                                                </span>
                                        ...
                                        <td align="center" class="act"><div style="position:relative">
                                                <span class="action_but" id="<?php echo $data->id ?>"></span>
