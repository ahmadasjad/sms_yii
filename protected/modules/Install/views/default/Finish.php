...
<p class="emphasize">SMS has been installed. It is important that you rename or remove <?php echo Yii::getPathOfAlias('application.modules.Install');?> folder to avoid other to run the installation again and delete your database.</p>
<div class="form">
    <h3></h3>
    <div class="content">
    <fieldset>
    ...
    <div class="input" align="center">
        ...
        <strong style="color: red">SMS uses SEO friendly URLs, you need to upload this file as <?php echo CHtml::link('.htaccess', array('default/htaccess'));?> to <?php echo Yii::getPathOfAlias('webroot');?> folder.</strong><br/>
        <?php endif;?>
