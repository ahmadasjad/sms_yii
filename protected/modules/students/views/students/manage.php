...
<div class="row">
    ...
    <div class="col-md-9 col-sm-9">
        <div class="box box-info ">
            <div class="box-header"><h3 class="box-title"><?php echo Yii::t('students', 'Manage Students'); ?></h3></div>
            <div class="box-body nav-tabs-custom">
                <div class="form-group">
                    <?php echo CHtml::link(Yii::t('students', 'Add Student'), array('create'), array('class' => 'addbttn last btn btn-success btn-sm')); ?>
                </div>
                <div class="cont_right formWrapper">
                    ...
                    <div class="filtercontner">
                        <div class="filterbxcntnt">
                            <!-- Filter List -->
                            <div class="filterbxcntnt_inner clearfix" style="border-bottom:#ddd solid 1px;">
                                <p><?php echo Yii::t('students', 'Filter Your Students:'); ?></p>
                                <style>
                    ...
                    <div class="contrht_bttns form-group">
                        ...
                        <a href="#" class="load_filter btn btn-primary btn-sm" onClick="hide('osload')">
                            <span> <?php echo Yii::t('students', 'Load Filter'); ?></span>
                        </a>
                        ...
                        <?php echo CHtml::link('<span>' . Yii::t('students', 'Clear All') . '</span>', array('manage'), array('class' => 'btn btn-primary btn-sm')); ?>
                        ...
                        <div class="letterNavCon" id="letterNavCon">
                            <ul class="list-inline">
                                ...
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'All'), Yii::app()->request->getUrl() . '&val=', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'A'), Yii::app()->request->getUrl() . '&val=A', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'B'), Yii::app()->request->getUrl() . '&val=B', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'C'), Yii::app()->request->getUrl() . '&val=C', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'D'), Yii::app()->request->getUrl() . '&val=D', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'E'), Yii::app()->request->getUrl() . '&val=E', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'F'), Yii::app()->request->getUrl() . '&val=F', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'G'), Yii::app()->request->getUrl() . '&val=G', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'H'), Yii::app()->request->getUrl() . '&val=H', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'I'), Yii::app()->request->getUrl() . '&val=I', array('class' => 'vtip btn btn-xs btn-info btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'J'), Yii::app()->request->getUrl() . '&val=J', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'K'), Yii::app()->request->getUrl() . '&val=K', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'L'), Yii::app()->request->getUrl() . '&val=L', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'M'), Yii::app()->request->getUrl() . '&val=M', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'N'), Yii::app()->request->getUrl() . '&val=N', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'O'), Yii::app()->request->getUrl() . '&val=O', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'P'), Yii::app()->request->getUrl() . '&val=P', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'Q'), Yii::app()->request->getUrl() . '&val=Q', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'R'), Yii::app()->request->getUrl() . '&val=R', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'S'), Yii::app()->request->getUrl() . '&val=S', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'T'), Yii::app()->request->getUrl() . '&val=T', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'U'), Yii::app()->request->getUrl() . '&val=U', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'V'), Yii::app()->request->getUrl() . '&val=V', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'W'), Yii::app()->request->getUrl() . '&val=W', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'X'), Yii::app()->request->getUrl() . '&val=X', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'Y'), Yii::app()->request->getUrl() . '&val=Y', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('students', 'Z'), Yii::app()->request->getUrl() . '&val=Z', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
