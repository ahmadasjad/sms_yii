...
<div class="row">
    ...
    <div class="col-md-9 col-sm-9">
        <div class="box box-info ">
            <div class="box-header"><h3 class="box-title"><?php echo Yii::t('settings', 'General Settings'); ?></h3></div>
            <div class="box-body nav-tabs-custom">
                <div class="setbx_bot">
                    <ul>
                        ...
                        <?php /* ?><li><?php echo CHtml::link(Yii::t('settings', 'News &amp; Events<span>Create/View Events</span>'), array('/cal'), array('class' => 'icon20')) ?></li>
                          <li><?php echo CHtml::link(Yii::t('settings', 'Translation<span>Language Translation</span>'), array('/translate/'), array('class' => 'icon20')) ?></li>
                          <li><a href="#" class="icon21">Authorization Manager<span>Admins &amp; Class Teachers</span></a></li>
                          ...
                          <li><a href="#" class="icon25">Server Info<span>Admins &amp; Class Teachers</span></a></li><?php */ ?>  
                    </ul>
                </div>
            </div>            
        </div>
        <div class="box box-info ">
            <div class="box-header"><h3 class="box-title"><?php echo Yii::t('settings', 'Enrollment Settings'); ?></h3></div>
            <div class="box-body nav-tabs-custom">
                <div class="setbx_bot">
                    <ul>
        ...
        <div class="box box-info ">
            <div class="box-header"><h3 class="box-title"><?php echo Yii::t('settings', 'Course/Batch Settings'); ?></h3></div>
            <div class="box-body nav-tabs-custom">
                <div class="setbx_bot">
                    <ul>
        ...
        <div class="box box-info ">
            <div class="box-header"><h3 class="box-title"><?php echo Yii::t('settings', 'Employee Settings'); ?></h3></div>
            <div class="box-body nav-tabs-custom">
                <div class="setbx_bot">
                    <ul>
        ...
        <div class="box box-info ">
            <div class="box-header"><h3 class="box-title"><?php echo Yii::t('settings', 'Financial Settings'); ?></h3></div>
            <div class="box-body nav-tabs-custom">
                <div class="setbx_bot">
                    <ul>
        ...
        <div class="box box-info ">
            <div class="box-header"><h3 class="box-title"><?php echo Yii::t('settings', 'SMS Settings'); ?></h3></div>
            <div class="box-body nav-tabs-custom">
                <div class="setbx_bot">
                    <ul>
