...
<div class="row">
    ...
    <div class="col-md-9 col-sm-9">
        <div class="box box-info ">
            <div class="box-header"><h3 class="box-title"><?php echo Yii::t('employees', 'Manage Employees'); ?></h3></div>
            <div class="box-body nav-tabs-custom">
                <div class="form-group">
                    <?php echo CHtml::link(Yii::t('employees', 'Add Employee'), array('create'), array('class' => 'addbttn last btn btn-success btn-sm')); ?>
                </div>
                <div class="cont_right formWrapper">
                    ...
                    <div class="filtercontner">
                        <div class="filterbxcntnt" >
                            <div class="filterbxcntnt_inner"  style="border-bottom:#ddd solid 1px;overflow: auto;">
                                <p><?php echo Yii::t('employees', 'Filter Your Employees:'); ?></p>
                                <style>
                                    ul#filter_criteria > li{
                                        float: left;
                                        margin-left: 15px;
                                    }
                                ...
                                ?>
                                <ul style="list-style:none;" id="filter_criteria">
                                    <li>
                                        <div onClick="hide('name')" style="cursor:pointer;"><?php echo Yii::t('employees', 'Name'); ?></div>
                    ...
                    <div class="contrht_bttns form-group">
                        <?php
                        echo CHtml::ajaxLink('<span>' . Yii::t('employees', 'Save Filter') . '</span>', $this->createUrl('Savedsearches/Create'), array(
                            'onclick' => '$("#jobDialog").dialog("open"); return false;',
                            'update' => '#jobDialog',
                            'type' => 'GET', 'data' => array('val1' => Yii::app()->request->getUrl(), 'type' => '2'), 'dataType' => 'text',
                                ), array('id' => 'showJobDialog', 'class' => 'saveic btn btn-primary btn-sm'));
                        ?>
                        <a href="#" class="load_filter btn btn-primary btn-sm" onClick="hide('load')">
                            <span><?php echo Yii::t('employees', 'Load Filter'); ?></span>
                        </a>
                        <div id="load" style="display:none;  overflow:scroll; height:200px; background:#fff; left:-40px; top:40px" class="drop">
                            ...
                            <ul class="loaddrop">
                                <li style="text-align:center">
                                    <?php
                                    $data = Savedsearches::model()->findAllByAttributes(array('user_id' => Yii::app()->User->id, 'type' => '2'));
                                    if ($data) {
                                        foreach ($data as $data1) {
                                            ...
                                            echo '</span>';
                                            echo '<span>';
                                            echo CHtml::link('<img src="images/cross.png" border="0" />', array('/savedsearches/deleteemp', 'user_id' => Yii::app()->User->id, 'sid' => $data1->id), array('confirm' => 'Are you sure you want to delete this?'));
                                            echo '</span>';
                                        }
                                    } else {
                        ...
                        <?php echo CHtml::link('<span>' . Yii::t('employees', 'Clear All') . '</span>', array('manage'), array('class' => ' btn btn-primary btn-sm')); ?>
                    ...
                    <div class="list_contner_hdng">
                        <div class="letterNavCon" id="letterNavCon">
                            <ul class="list-inline">
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'All'), Yii::app()->request->getUrl() . '&val=', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'A'), Yii::app()->request->getUrl() . '&val=A', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'B'), Yii::app()->request->getUrl() . '&val=B', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'C'), Yii::app()->request->getUrl() . '&val=C', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'D'), Yii::app()->request->getUrl() . '&val=D', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'E'), Yii::app()->request->getUrl() . '&val=E', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'F'), Yii::app()->request->getUrl() . '&val=F', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'G'), Yii::app()->request->getUrl() . '&val=G', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'H'), Yii::app()->request->getUrl() . '&val=H', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'I'), Yii::app()->request->getUrl() . '&val=I', array('class' => 'vtip btn btn-xs btn-info btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'J'), Yii::app()->request->getUrl() . '&val=J', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'K'), Yii::app()->request->getUrl() . '&val=K', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'L'), Yii::app()->request->getUrl() . '&val=L', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'M'), Yii::app()->request->getUrl() . '&val=M', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'N'), Yii::app()->request->getUrl() . '&val=N', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'O'), Yii::app()->request->getUrl() . '&val=O', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'P'), Yii::app()->request->getUrl() . '&val=P', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'Q'), Yii::app()->request->getUrl() . '&val=Q', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'R'), Yii::app()->request->getUrl() . '&val=R', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'S'), Yii::app()->request->getUrl() . '&val=S', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'T'), Yii::app()->request->getUrl() . '&val=T', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'U'), Yii::app()->request->getUrl() . '&val=U', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'V'), Yii::app()->request->getUrl() . '&val=V', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'W'), Yii::app()->request->getUrl() . '&val=W', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'X'), Yii::app()->request->getUrl() . '&val=X', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'Y'), Yii::app()->request->getUrl() . '&val=Y', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                ?>
                                <li class="<?php echo $activ_class; ?>">
                                    <?php echo CHtml::link(Yii::t('employees', 'Z'), Yii::app()->request->getUrl() . '&val=Z', array('class' => 'vtip btn btn-info btn-xs btn-flat')); ?>                            
                                </li>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <?php foreach ($list as $list_1) {
                                        ...
                                        <tr class=<?php echo $cls; ?> id=<?php echo $i; ?>>
                                            ...
                                            <?php
                                            $batc = EmployeeDepartments::model()->findByAttributes(array('id' => $list_1->employee_department_id));
                                            if ($batc != NULL) {
                                                ?>
                                            ...
                                            <td><?php
                                                ...
                                                ?></td>
                                            <td><?php
                                                //echo CHtml::ajaxlink('Delete',array('employees/manage','id'=>$list_1->id),array('confirm'=>'Do you want to delete Employee ?')) 
