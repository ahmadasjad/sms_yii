...
<div class="row">
    ...
    <div class="col-md-9 col-sm-9">
        <div class="box box-info ">
            <div class="box-header"><h3 class="box-title"><?php echo Yii::t('employees', 'Manage Employee Categories'); ?></h3></div>
            <div class="box-body nav-tabs-custom">
                <?php echo CHtml::link(Yii::t('employees', '<span>Add New Category</span>'), array('create'), array('class' => 'addbttn last btn btn-primary btn-sm')); ?>
                <?php
