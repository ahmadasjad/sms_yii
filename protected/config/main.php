...
return array(
    ...
    'import' => array(
        ...
        'application.vendor.CustomLibrary.*',
    ),
    'aliases' => array(
...
//        ),
    ...
    'components' => array(
        ...
        'log' => array(
            ...
            'routes' => array(
                array(
                    'class' => 'CFileLogRoute', //,'ext.yii-debug-toolbar.YiiDebugToolbarRoute') ,
        ...
        'clientScript' => array(
            'packages' => array(
                'jquery' => array(
                    'baseUrl' =>  @Yii::app()->request->baseUrl . '/sms_yii/public/design/plugins/jQuery/',
