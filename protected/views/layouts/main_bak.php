...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <script>
<?php if (isset(Yii::app()->controller->module->id) and ( Yii::app()->controller->module->id == 'hostel' || Yii::app()->controller->module->id == 'transport' || Yii::app()->controller->module->id == 'library' || Yii::app()->controller->module->id == 'downloads')) { ?>
                $(document).ready(function () {
