<div class="formCon">
    ...
    <div class="formConInner">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td><?php
                    ...
                    echo CHtml::textField('address', $val_2->config_value, array());
                    ?></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td><?php
                    ...
                    echo CHtml::textField('phone', $val_3->config_value, array());
                    ?></td>
            ...
            <tr>
                ...
                <td> <?php
                    ...
                    echo CHtml::textField('currency', $val_8->config_value, array());
                    ?></td> 
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td><?php
                    ...
                    echo CHtml::dropDownlist('network', '', array('Online' => 'Online', 'Offline' => 'Offline'), array('options' => array($val_9->config_value => array('selected' => true))));
                    ?></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
        ...
        <div class="row">
            <div class="col-sm-6">
                <?php echo CHtml::checkBox('admission_number', array('checked' => 'checked')); ?>
                <?php echo Yii::t('settings', 'Enable Auto increment Student admission no.'); ?> 
            </div>
            <div class="col-sm-6">
                <?php echo CHtml::checkBox('employee_number', array('checked' => 'checked')); ?>
