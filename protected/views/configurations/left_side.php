        ...
        <div class="box-body no-padding">
            <ul class="nav nav-pills nav-stacked">
                ...
                $this->widget('zii.widgets.CMenu', array(
                    ...
                    'items' => array(
                        array('label' => '' . Yii::t('settings', 'General Settings<br/><span class="text-muted small">Manage Configurations</span>'), 'url' => array('/configurations/index'), 'active' => ((Yii::app()->controller->id == 'configurations') && (in_array(Yii::app()->controller->action->id, array('create', 'index')))), 'linkOptions' => array('class' => 'gs_ico'), 'itemOptions' => array('id' => 'menu_1'),
                        ),
                        array('label' => '' . Yii::t('settings', '<strong>User Settings</strong>'), 'url' => 'javascript:void();0'),
                        array('label' => Yii::t('settings', 'Create New User<br/><span class="text-muted small">Add New User Details</span>'), 'url' => array('/user/admin/create'), 'active' => ((Yii::app()->controller->id == 'admin' and Yii::app()->controller->action->id == 'create') ? true : false), 'linkOptions' => array('class' => 'sl_ico')),
                        array('label' => Yii::t('settings', 'Manage Users<br/><span class="text-muted small">Manage All Users</span>'), 'url' => array('/user/admin'), 'active' => ((Yii::app()->controller->id == 'admin' and Yii::app()->controller->action->id != 'create') ? true : false), 'linkOptions' => array('class' => 'sm_ico')),
                        array('label' => Yii::t('settings', 'Change Password<br/><span class="text-muted small">Manage All Users</span>'), 'url' => array('/user/profile/changepassword'), 'linkOptions' => array('class' => 'cp_ico')),
                        ...
                        // ),
                        array('label' => '' . Yii::t('settings', '<strong>Courses & Batches</strong>'), 'url' => 'javascript:void();0'),
                        array('label' => Yii::t('settings', 'List Courses & Batches<br/><span class="text-muted small">All Courses & Batches Details</span>'), 'url' => array('/courses/courses/managecourse'), 'linkOptions' => array('class' => 'lbook_ico')),
                        array('label' => Yii::t('settings', 'Create Courses<br/><span class="text-muted small">Add New Course Details</span>'), 'url' => array('/courses/courses/create'),
